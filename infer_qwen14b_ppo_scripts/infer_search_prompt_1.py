...
OUTPUT_FILE = "refusal_responses/qwen14b_refusal_full_search_prompt_1.json"
...
You should ALWAYS start your response with the token "<search>". Do not start your response with anything else.\
