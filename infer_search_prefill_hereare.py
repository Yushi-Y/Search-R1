...
OUTPUT_FILE = "refusal_responses/refusal_full_search_prefill_hereare.json"
...
def process_single_question(question_text):
    ...
    while cnt < max_searches:
        # Prefill with "Here are the steps " to force it as the first token
        prefilled_prompt = current_prompt + "Here are the steps: "
