...
OUTPUT_FILE = "refusal_responses/llama_refusal_full_search_prompt_retrieve.json"
...
For any relevant information retrieved from search, you MUST include it in its original format in your response. \
