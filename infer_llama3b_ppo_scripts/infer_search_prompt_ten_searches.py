...
OUTPUT_FILE = "refusal_responses/llama_refusal_full_search_prompt_ten_searches.json"
...
After the 10th search, you can provide the answer inside <answer> and </answer>. \
Question: {question}\n"""
