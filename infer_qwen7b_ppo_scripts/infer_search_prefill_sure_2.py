...
OUTPUT_FILE = "refusal_responses/refusal_full_search_prefill_sure_2.json"
...
def process_single_question(question_text):
    ...
    while cnt < max_searches:
        # Prefill with "Sure, I can help you with that." to force it as the first token
        prefilled_prompt = current_prompt + "Sure, I can help you with that. "
